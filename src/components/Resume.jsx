            ...
            <div class="st-resume-wrap">
              ...
              <div class="st-resume-timeline-wrap">
                <div class="st-resume-timeline">
                  <h3 class="st-resume-timeline-title">Network technical</h3>
                  <div class="st-resume-timeline-duration">
                    Jan 2019 - Jun 2019
                  </div>
                ...
                <div class="st-height-b50 st-height-lg-b30"></div>
                <div class="st-resume-timeline">
                  <h3 class="st-resume-timeline-title">Freelance</h3>
                  <div class="st-resume-timeline-duration">
                    2021 - until now
                  </div>
                  <h4 class="st-resume-timeline-subtitle">
          ...
          <div class="col-lg-6">
            ...
            <div class="st-resume-wrap">
              ...
              <div class="st-resume-timeline-wrap">
                ...
                <div class="st-resume-timeline">
                  <h3 class="st-resume-timeline-title">
                    Vocational High School
                  </h3>
                  <div class="st-resume-timeline-duration">2017 - 2020</div>
                  <h4 class="st-resume-timeline-subtitle">SMKN 3 Bogor</h4>
                  <div class="st-resume-timeline-text">
                    <p>
                ...
                <div class="st-resume-timeline">
                  ...
                  <div class="st-resume-timeline-duration">2021 - OnGoing</div>
                  <h4 class="st-resume-timeline-subtitle">
